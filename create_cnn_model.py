...
X_total_2 = numpy.append(X_total_1, X_train_whole[choice, :], axis=0)
X_total = numpy.append(X_total_2, X_train_whole[choice, :], axis=0)
print(X_total.shape)
...
model.add(Conv1D(filters=40, kernel_size=6, padding='valid', activation='relu', strides=2))
...
hist = model.fit(input, Y_train, batch_size=32, epochs=1300, verbose=1, validation_data=(testinput, Y_test), steps_per_epoch=None)		
